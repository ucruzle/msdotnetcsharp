  ...
  DECLARE
	...
	BEGIN TRY 
	  BEGIN TRANSACTION /* Inicia a transação para modificações da tabela CabecalhoModificacoes */
		  ...
		  /* Gravar dados referentes ao cadastro de Lançamento de Exceções */
	  ...
	  COMMIT TRANSACTION /* Finaliza a transação para modificações da tabela de Lançamento de Exceções */
	END TRY 
	  BEGIN CATCH 
