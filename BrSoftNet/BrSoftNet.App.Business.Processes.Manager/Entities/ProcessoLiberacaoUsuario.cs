...
{
    public class ProcessoLiberacaoUsuario
    {
        #region Properties
        ...
        public ProcessoLiberacaoUsuario(DataRow _Row) 
        {
        ...
        public ProcessoLiberacaoUsuario(bool _Liberar, int _CodigoProcesso, string _DescricaoProcesso, int _CodigoTipoProcesso, int _CodigoAplicacao, string _Ativo, string _Form, int _SequenciaProcesso) 
        {
            Liberar = _Liberar;
        ...
        public ProcessoLiberacaoUsuario() { }
